...
const Sidebar = () => {
  ...
  return (
    <div
      className={`flex flex-col items-center text-light-color-text my-4 top-0 bottom-0 md:h-full w-[--sidebar-width] bg-light-bg md:rounded absolute left-0 transition-all duration-500 md:relative md:mr-4 p-2 ${
